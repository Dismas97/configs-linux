...
- [[#paquetes][Paquetes]]
  ...
  - [[#paquetues-desarrollo][Paquetues desarrollo]]
...
Inicializando org agenda, en mi caso guardo mis org en mi carpeta organizacion.
#+begin_src emacs-lisp 
(setq org-agenda-files (list "~/Organizacion/Tareas.org"))
#+end_src
